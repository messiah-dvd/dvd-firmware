...
/* Definitions for peripheral ACF_AXI_MINI_0 */
#define XPAR_ACF_AXI_MINI_0_BASEADDR 0x43C10000
#define XPAR_ACF_AXI_MINI_0_HIGHADDR 0x43C1FFFF
...
#define XPAR_FABRIC_VTC_0_VEC_ID XPAR_FABRIC_V_TC_OUT_IRQ_INTR
