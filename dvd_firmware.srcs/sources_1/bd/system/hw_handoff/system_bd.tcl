...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set je [ create_bd_port -dir I -from 7 -to 0 -type data je ]
  set led [ create_bd_port -dir O -from 3 -to 0 -type data led ]

  # Create instance: ACF_AXI_mini_0, and set properties
  set ACF_AXI_mini_0 [ create_bd_cell -type ip -vlnv messiah.edu:user:ACF_AXI_mini:1.5 ACF_AXI_mini_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ACF_AXI_mini_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net ACF_AXI_mini_0_diag [get_bd_ports led] [get_bd_pins ACF_AXI_mini_0/diag]
  connect_bd_net -net ACLK_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_out/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net je_1 [get_bd_ports je] [get_bd_pins ACF_AXI_mini_0/CH1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ACF_AXI_mini_0/s00_axi_aresetn] [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_out/s_axi_aresetn]
  ...
  connect_bd_net -net xlconstant_axis_sc_reset_dout [get_bd_pins axis_subset_converter_out/aresetn] [get_bd_pins xlconstant_axis_sc_reset/dout]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ACF_AXI_mini_0/s00_axi/reg0] -force
