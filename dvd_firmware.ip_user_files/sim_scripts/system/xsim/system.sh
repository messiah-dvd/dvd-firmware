...
xv_boost_lib_path=C:/Vitis/Vivado/2019.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="C:/Vitis/Vivado/2019.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
