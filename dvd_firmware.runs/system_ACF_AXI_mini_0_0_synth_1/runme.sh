...
HD_PWD='C:/Users/nc1220/xilinx_workspace/dvd_firmware/dvd_firmware.runs/system_ACF_AXI_mini_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ACF_AXI_mini_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ACF_AXI_mini_0_0.tcl
